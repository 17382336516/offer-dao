...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="Browser name (chrome/edge) for yt-dlp to read Bilibili login cookies; "
        "required to fetch subtitles that are hidden in guest mode",
    )
    ...
    if need_extract or need_public_subtitles or need_comments:
        ...
        if args.cookies_from_browser:
            ...
            cmd.append(args.cookies_from_browser)
        if args.force:
            cmd.append("--force")
